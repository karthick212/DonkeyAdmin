  ...
  methods:{
    autoInc(){
      ...
      if (this.$route.params.id==undefined) {
           let uri = 'http://localhost:4000/courier/CourierCompany/Auto';
              this.axios.get(uri).then((response) => {
                ...
                let uri = 'http://localhost:4000/courier/CourierCompany/edit/' + this.$route.params.id;
                this.axios.get(uri).then((response) => {
         ...
         addItem(){
        let uri = 'http://localhost:4000/courier/CourierCompany/add';
        if(this.$route.params.id!=undefined)         
         uri = 'http://localhost:4000/courier/CourierCompany/update';
        this.item.id=this.id;
